...
bool Currency::generateGenesisBlock() {
  ...
  // If you get the "Failed to parse coinbase tx from hard coded blob" error, chances are the genesis hash isn't here
  std::string genesisCoinbaseTxHex = "010a01ff0001ece9d9b6c137029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121013d2814f78c8fdfecb85b32f4d2e7aa7abdad5b0ee89568f0cb7f02cd117ca2fa";
  ...
  if (!r) {
    logger(ERROR, BRIGHT_RED) << "failed to parse coinbase tx from hard coded blob; Make sure the Genesis Block hash is in Currency.cpp";
    return false;
  }
...
bool Currency::getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  uint64_t baseReward = (m_moneySupply - alreadyGeneratedCoins) >> m_emissionSpeedFactor;
   ...
   if (alreadyGeneratedCoins == 0) {
        ...
        if (alreadyGeneratedCoins <12000000000000000) {       //  Premine 120 million EuroBit for legacy chain transfer
            baseReward = 12000000000000000;
        }
